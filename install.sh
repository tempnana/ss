...
get_shadowsocks_config() {
    ...
    echo -e "\033[1;33;46m$ss_url\033[0m"
    echo ''
}
...
get_kcptun_config() {
    ...
    echo -e "\033[1;33;46m$kcptun_m_config\033[0m"
    echo ''
